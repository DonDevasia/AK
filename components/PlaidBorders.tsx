...
export default function PlaidBorders() {
  return (
    <>
      {/* Top Left Border */}
      <div 
        className="absolute top-0 left-0 w-24 sm:w-48 h-24 sm:h-48 z-10 pointer-events-none drop-shadow-md"
        style={{
      ...
      {/* Top Right Border */}
      <div 
        className="absolute top-0 right-0 w-24 sm:w-48 h-24 sm:h-48 z-10 pointer-events-none drop-shadow-md"
        style={{
      ...
      {/* Bottom Left Border */}
      <div 
        className="absolute bottom-0 left-0 w-32 sm:w-64 h-16 sm:h-32 z-10 pointer-events-none drop-shadow-md"
        style={{
      ...
      {/* Bottom Right Border */}
      <div 
        className="absolute bottom-0 right-0 w-32 sm:w-64 h-16 sm:h-32 z-10 pointer-events-none drop-shadow-md"
        style={{
